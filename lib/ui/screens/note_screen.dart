...
class _NoteScreenState extends State<NoteScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    try {
      final doc = _note.content.isNotEmpty
          ? quill.Document.fromJson(jsonDecode(_note.content))
          : quill.Document();
  ...
  Widget build(BuildContext context) {
    ...
    if (theme.colorScheme.primary == AppTheme.comfyColors['primary']) {
      // Comfy theme
      noteBgColor = AppTheme.comfyColors['background']!;
      textColor = AppTheme.comfyColors['textDark']!;
      iconColor = AppTheme.comfyColors['textDark']!;
      appBarBgColor = Colors.transparent;
      appBarIconColor = AppTheme.comfyColors['textDark']!;
      titleTextColor = AppTheme.comfyColors['textDark']!;
      borderColor = AppTheme.comfyColors['textDark']!;
    } else if (theme.brightness == Brightness.dark) {
      // Dark theme
      noteBgColor = AppTheme.darkColors['background']!;
      textColor = AppTheme.darkColors['primaryText']!;
      iconColor = AppTheme.darkColors['primaryText']!;
      appBarBgColor = Colors.black;
      appBarIconColor = AppTheme.darkColors['primaryText']!;
      titleTextColor = AppTheme.darkColors['primaryText']!;
      borderColor = AppTheme.darkColors['border']!;
    } else {
      // Light theme
      noteBgColor = AppTheme.lightColors['background']!;
      textColor = AppTheme.lightColors['primaryText']!;
      iconColor = AppTheme.lightColors['primaryText']!;
      appBarBgColor = Colors.transparent;
      appBarIconColor = AppTheme.lightColors['primaryText']!;
      titleTextColor = AppTheme.lightColors['primaryText']!;
      borderColor = AppTheme.lightColors['border']!;
    }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            const SizedBox(width: 4),
            // Popup menu for Share, Delete, Upload Image (rightmost)
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.label, size: 18, color: Colors.white),
                      ),
                    ),
                    // All tags
                    ..._tags.map((tag) {
              ...
              // Quill Editor (only this is scrollable)
              Expanded(
                child: Container(
  ...
  Future<void> _pickReminder() async {
    ...
    await notificationService.scheduleNoteReminder(_note);
  }
