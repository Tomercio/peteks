...
void main() {
  testWidgets('App smoke test', (WidgetTester tester) async {
    ...
    // The original counter test no longer applies to our app, so remove those expectations

    // Instead, just verify that the app title appears
    expect(find.text('Peteks'), findsOneWidget);
  });
}
